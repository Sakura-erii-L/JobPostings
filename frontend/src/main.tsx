...
type RecruitmentSharedDetail = { id: string; batch_name?: string; batch_year?: number; batch_season?: string; recruitment_type?: string; locations: string[]; salary: Record<string, any>; source_type?: string; source_url?: string; observed_at?: string }
