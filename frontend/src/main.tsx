...
type Evidence = { id: string; source_url?: string; source_type: string; excerpt?: string; artifact_id?: string; observed_at?: string; raw_text?: string; ocr_text?: string; sender?: string; sent_at?: string; source_group_name?: string; filename?: string; mime_type?: string; metadata?: Record<string, any> }
...
function App() {
  ...
  const [page, setPage] = useState<'companies' | 'timeline' | 'applications' | 'import' | 'admin' | 'queue' | 'settings' | 'review'>('companies')
